...
- **O ciclo é dirigido por distância percorrida, nunca por tempo.** Um ciclo no relógio anda no próprio ritmo enquanto a personagem anda no ritmo da AGI dela, e os dois se afastam até os pés patinarem no chão. Amarrado à distância, o pé encosta sempre no mesmo ponto do percurso.
    - `RunCycleCells` diz quanto chão um ciclo inteiro cobre. Um significa um ciclo por casa. A taxa de quadros que isso produz é a velocidade de deslocamento dividida por `RunCycleCells` e multiplicada pelo número de quadros, e o alvo é a faixa de 8 a 12 quadros por segundo, em que ciclo de corrida em pixel art costuma ficar legível. As casas por segundo de cada ficha estão no `snapshot.md`, que é de onde a conta sai.
    - **Não vale afrouxar mais que isso.** Uma casa no combate é atravessada rápido demais para o ciclo inteiro caber num passo com folga. Esticar o ciclo faz a personagem mostrar uma passada pela metade, o que lê como quebrado e não como devagar.
- **A caminhada do combate é sempre um vislumbre, e isso é fato de design e não defeito.** O lugar onde a animação realmente aparece é a rolagem entre ondas, que dura vários segundos e roda o ciclo inteiro várias vezes seguidas. É lá que vale julgar o ciclo.
